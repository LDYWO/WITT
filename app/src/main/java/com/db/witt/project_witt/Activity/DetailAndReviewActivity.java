...
import com.db.witt.project_witt.Adapter.Review_Detail_Adapter;
import com.db.witt.project_witt.R;
import com.db.witt.project_witt.Request.DislikeRequest;
import com.db.witt.project_witt.Request.LikeRequest;
import com.db.witt.project_witt.Request.ToiletDetailRequest;
...
public class DetailAndReviewActivity extends AppCompatActivity {
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute(){
            try {
                target = "http://ec2-13-209-75-74.ap-northeast-2.compute.amazonaws.com/LikeValidate.php?userEmail=" + URLEncoder.encode(userEmail,"UTF-8") + "&toilet_id=" + URLEncoder.encode(toilet_id,"UTF-8");
