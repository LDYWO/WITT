...
import com.db.witt.project_witt.Request.WriteReviewRequest;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.newPost: {
                ...
                if(bitmapString=="null"){
                    ...
                    Bitmap bitmap = BitmapFactory.decodeResource(WriteReviewActivity.this.getResources(), R.drawable.logo);
