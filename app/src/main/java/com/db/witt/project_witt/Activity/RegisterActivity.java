...
import com.db.witt.project_witt.Request.RegisterRequest;
import com.db.witt.project_witt.Request.ValidateRequest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (userEmail.equals("") || userPassword.equals("") || userNickname.equals("") || userAge.equals("") || userGender.equals("")){
                    AlertDialog.Builder builder = new AlertDialog.Builder(RegisterActivity.this);
